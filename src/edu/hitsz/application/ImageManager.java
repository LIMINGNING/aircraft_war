...
import edu.hitsz.enemy.SuperEliteEnemy;
...
public class ImageManager {
    ...
    public static BufferedImage PROP_FIREPLUS_IMAGE;
    ...
    static {
        try {
            ...
            CLASSNAME_IMAGE_MAP.put(FirePlusProp.class.getName(), PROP_FIREPLUS_IMAGE);
